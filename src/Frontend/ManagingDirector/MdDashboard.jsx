    ...
    <div className="dashboard-container">
      ...
      <header className="dashboard-navbar">
        ...
        <div className="navbar-right">
          <Link to="/managing-director-dashboard/notifications">
          ...
          <div className="profile-wrapper" onClick={toggleProfile}>
            ...
            {isProfileOpen && (
              <div className="profile-dropdown">
                <Link to="/managing-director-dashboard/profile">Profile</Link>
                <Link to="/managing-director-dashboard/change-password">
                  Change Password
                </Link>
                <Link to="/">Logout</Link>
              </div>
      ...
      <div className="dashboard-body">
            ...
            {sidebarLinks.map((link) => (
              <div
                ...
                onClick={() => {
                  ...
                  navigate(`/managing-director-dashboard/${link.path}`);
        ...
        <main className="dashboard-main">
          ...
          <Routes>
            <Route
              path="notifications"
              element={<Notifications token={token} user={user} />}
            />
