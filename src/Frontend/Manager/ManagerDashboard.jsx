...
import { FaUserCircle, FaUserPlus, FaUsers, FaBell,
  FaTasks, FaHistory, FaChartBar, FaBars, FaTimes, FaArrowUp
 } from "react-icons/fa";
    ...
    <div className="dashboard-container">
      ...
      <header className="dashboard-navbar">
        ...
        <div className="navbar-right">
          <Link to="/manager-dashboard/notifications">
          ...
          <div className="profile-wrapper" onClick={toggleProfile}>
            ...
            {isProfileOpen && (
              <div className="profile-dropdown">
                <Link to="/manager-dashboard/profile">Profile</Link>
                <Link to="/manager-dashboard/change-password">Change Password</Link>
                <Link to="/">Logout</Link>
              </div>
            )}
          </div>
            ...
            {sidebarLinks.map((link) => (
              <div
                ...
                onClick={() => {
                  ...
                  navigate(`/manager-dashboard/${link.path}`);
