    ...
    <div className="dashboard-container">
      ...
      <header className="dashboard-navbar">
        ...
        <div className="navbar-right">
            <Link to="/director-dashboard/notifications">
          ...
          <div className="profile-wrapper" onClick={toggleProfile}>
            ...
            {isProfileOpen && (
              <div className="profile-dropdown">
                <Link to="/director-dashboard/profile">Profile</Link>
                <Link to="/director-dashboard/change-password">Change Password</Link>
                <Link to="/">Logout</Link>
              </div>
            )}
          </div>
            ...
            {sidebarLinks.map((link) => (
              <div
                ...
                onClick={() => {
                  ...
                  navigate(`/director-dashboard/${link.path}`);
